...
public class TelaExcluirFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Enviar.setFont(new java.awt.Font("Noto Sans", 1, 14)); // NOI18N
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(640, 70));
    ...
    private void EnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnviarActionPerformed
        Funcionario DelFuncionario;

        DelFuncionario = new Funcionario ((Cpf.getText().replace(".", "").replace("-", "")),"","","","");

        DelFuncionario.excluir();
        
        Cpf.setText("");
        
        saida1.setText("Funcionario excluido com sucesso");
